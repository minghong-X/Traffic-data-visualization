    ...
    <div class="page2">
        <Row class='content'>
            <Col span="8">
                <div class="list">
                    <div class="left">
                        <span class='title'><span class="title-4">车辆分析</span></span>
                ...
                <div class="list">
                    <div class="left">
                        <span class='title'><span class="title-8">过车车挡类型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
            ...
            <Col span="8">
                <div class="list">
                    <div class="right">
                        <span class='title'><span class="title-4">过车类型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                ...
                <div class="list">
                    <div class="right">
                        <span class='title'><span class="title-8">D车挡车型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
        ...
        <Row class="bottom-list">
            <Col span="16">
                <div class="list">
                    <div class="bottom">
                        <span class='title'><span class="title-10">H车挡车型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                ...
                <div class="list">
                    <div class="bottom">
                        <span class='title'><span class="title-10">Q车挡车型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                ...
                <div class="list">
                    <div class="bottom">
                        <span class='title'><span class="title-10">Z车挡车型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
            ...
            <Col span="8">
                <div class="list right-bottom">
                    <div class="bottom bottom1">
                        <span class='title'><span class="title-10">K车挡车型分析</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
...
export default {
    ...
    data() {
        return {
            ...
            title: ['累计过车数量:32,702', 'K车辆类型数量:22,303', 'H车辆类型数量:2,219', 'Q车辆类型数量:56', 'Z车辆类型数量:237', 'D车辆类型数量:1'],
            cnfigData1: {
                color: '#5CB1C1',
                name: ['（辆）'],
                data: [
                    {
                        name: '过车数量',
                        color: ['#9e70ff', '#6e5eff'],
                        data: [6097, 5435, 5398, 5434, 4781, 5557],
                    }
                    // ,
                    // {
                    //     name: '聊天人数',
                ...
                data: [
                    {
                        name: '过车数量',
                        color: '#0DF5F8',
                        value: [6097, 5435, 5398, 5434, 4781, 5557],
                    }
                    // ,
                    // {
                    //     name: '聊天人数',
                ...
                data: [
                    {
                        name: '过车总数',
                        color: '#FA8486',
                        value: [44, 10282, 21, 304, 8, 1805, 68, 6, 1752, 15133, 671, 2606],
                    }
                ]
            },
            momentsRadarData: {
    ...
    methods: {
        ...
        drawText(ctx, nowRange) {
            ...
            ctx.fillText(nowRange + '辆', 120, 120 - size / 2);
            ctx.restore();
            ctx.save()
            size = 25;
            ctx.translate(130, 130);
